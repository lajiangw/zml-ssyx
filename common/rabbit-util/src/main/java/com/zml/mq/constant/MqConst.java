package com.zml.mq.constant;

/**
 * @author ZhangMinlei
 * @description
 * @date 2023-07-12 20:36
 */
public class MqConst {
    ...
    public static final String ROUTING_GOODS_DELETE = "ssyx.goods.delete";
    //队列
    ...
    public static final String QUEUE_GOODS_DELETE = "ssyx.goods.delete";
